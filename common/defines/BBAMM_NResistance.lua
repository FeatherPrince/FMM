...
NDefines.NResistance.COMPLIANCE_FACTOR_ON_STATE_CONTROLLER_CHANGE = 0.1;	--default -0.5-- compliance factor that applies when the state controller changes (in between allies; compliance is zeroed if it is taken by original country)
