...
NDefines.NProduction.BASE_FACTORY_SPEED_MIL = 2.5;								--default 4.75-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NDefines.NProduction.INFRA_MAX_CONSTRUCTION_COST_EFFECT = 0.25;					--default 1--Building in a state with higher infrastructure will reduce the cost of shared buildings.
...
NDefines.NProduction.MIN_NAVAL_EQUIPMENT_CONVERSION_IC_COST_FACTOR = 0.0;		--default 0.2-- Fraction of the hull industry cost which is always included in the refitting cost.
NDefines.NProduction.MIN_LAND_EQUIPMENT_CONVERSION_IC_COST_FACTOR = 1.0;		--default 0.9-- Fraction of the chassis industry cost which is always included in the conversion cost.
